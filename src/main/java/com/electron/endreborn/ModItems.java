...
public class ModItems {
	...
	public static final RegistryObject<HoeItem> ENDORIUM_HOE = ITEMS.register("endorium_hoe", () -> new CustomHoeItem(ModMaterials.TOOL_ENDORIUM,1, -1f, new Item.Properties().group(EndReborn.ENDGROUP)));
