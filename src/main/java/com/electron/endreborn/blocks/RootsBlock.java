...
public class RootsBlock extends FlowerBlock implements net.minecraftforge.common.IShearable {
    ...
    protected boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
        ...
        return block == ModBlocks.END_MUSHROOM.get() || block == ModBlocks.ROOTS.get();
    }
    ...
    public VoxelShape getShape(BlockState state, IBlockReader worldIn, BlockPos pos, ISelectionContext context) {
        ...
        return state.get(DOUBLE) ? SHAPE1.withOffset(vec3d.x, vec3d.y, vec3d.z) : SHAPE.withOffset(vec3d.x, vec3d.y, vec3d.z);
    }
