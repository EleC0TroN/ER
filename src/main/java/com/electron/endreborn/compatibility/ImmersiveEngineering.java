...
public class ImmersiveEngineering {
    ...
    public static final RegistryObject<BlockItem> WOLFRAMIUM_SHEETMETAL = ITEMS.register("sheetmetal_wolframium", () -> new BlockItem(ModBlocks.TUNGSTEN_SHEETMETAL.get(), new Item.Properties().group(ImmersiveEngineering.isInstalled() ? EndReborn.ENDOMPAT : null)));
