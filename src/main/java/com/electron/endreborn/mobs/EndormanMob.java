...
public class EndormanMob extends MonsterEntity {
    ...
    private void updateEndorSize() {
        ...
        this.getAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(7 + this.getEndorSize());
        this.getAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue((double)(0.3 - 0.02 * this.getEndorSize()));
        this.getAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(40 + 3 * this.getEndorSize());
    ...
    private boolean shouldAttackPlayer(PlayerEntity player) {
        ...
        if (itemstack.getItem() == Blocks.CARVED_PUMPKIN.asItem()) {
            ...
            Vec3d vec3d1 = new Vec3d(this.getPosX() - player.getPosX(), this.getPosYEye() + (0.2F * (float)i) - player.getPosYEye(), this.getPosZ() - player.getPosZ());
