...
public class PlantFeature extends Feature<OreFeatureConfig> {
	public PlantFeature(Function<Dynamic<?>, ? extends OreFeatureConfig> config) {
        super(config);
	}
		                        ...
		                        for(int j2 = l; j2 <= k1; ++j2) {
		                           ...
		                           if (d8 * d8 + d9 * d9 + d10 * d10 < 2.0D) {
		                              ...
		                              if (!bitset.get(k2)) {
		                                 ...
		                                 if (world.getBlockState(blockpos$mutable.down()).getBlock() == Blocks.GRASS_BLOCK && world.isAir(blockpos$mutable))
		                                 {
